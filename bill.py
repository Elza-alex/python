...
#Menu Card
f=Frame(root,bg="light green",highlightbackground="black",highlightthickness=1,width=320,height=370)
f.place(x=10,y=118)
...
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Cookies...............Rs.10/plate",fg="black",bg="lightgreen").place(x=10,y=110)
...
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Pancakes...............Rs.20/plate",fg="black",bg="lightgreen").place(x=10,y=200)
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Cake...............Rs.500/plate",fg="black",bg="lightgreen").place(x=10,y=230)
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Egg...............Rs.8/plate",fg="black",bg="lightgreen").place(x=10,y=260)
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Juice...............Rs.50/plate",fg="black",bg="lightgreen").place(x=10,y=290)
